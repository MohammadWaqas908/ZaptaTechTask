...
<div class="container">
    <div class="card">
        <div class="card-header">
          <a href="{{url('/admin-teacher/create')}}" class="btn btn-primary">Add Teacher</a>
          @if (session('message'))
                ...
                <tbody>
                  @foreach ($users as $index=>$user)
                    <tr>
                        ...
                        <td>
                          <a href="{{url('admin-teacher/'.$user->id.'/edit')}}" class="btn btn-primary">Edit</a>
                        </td>
                    </tr>
                  @endforeach
                </tbody>
    ...
    <script>
      $(document).ready(function () {
        $('.enable_disable_status').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/admin-teacher/'+thisRef.attr('id'),
